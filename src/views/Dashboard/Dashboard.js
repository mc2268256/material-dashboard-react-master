...
import DegreeCentralityMode from "../../components/DegreeCentralityMode"
import NcMode from "../../components/NcMode"
import CcMode from "../../components/CcMode"
...
// const keywordFilter = (object, arg) => { //判断object是否为满足arg的结果
//     return (object.Abstract.indexOf(arg) != -1 || object.Title.indexOf(arg) != -1)
// }
