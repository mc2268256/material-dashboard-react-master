...
// const localClusteringCoefficient = (graph) => {//聚集系数，描述自中心网络中学者间的合作紧密程度
...
//     const result = {}
//     graph.nodes.forEach(  (name) => {
//         result[name] = (2*edgeNum[name]) / (DC[name]* (DC[name] - 1))
//     })
...
export default function DegreeCentralityMode(props){
    const UID ="w9378rgfyu3w587tgafgw0837gabubbka9p8h49w[8ro3ay8wraw[rohga[5ryihihlihlhlih"
                    ...
                    
                    {
                        ...
                        tooltip:{
                                formatter:function(params){
                                    ...
                                    show += `<a>总度中心性数${data[1]}</a><br/>`
                                    show += `<a>平均度中心性数${params.data}</a>`
                                    return show
                                }
                            }
                    }
